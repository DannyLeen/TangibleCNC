/////////////////////////////////////////////////////////////////
/*
  PushButton.h - Arduino Library to simplify working with buttons.
...
class PushButton {
  private:
    ...
    typedef void (*CallbackFunction) (PushButton&);
  ...
  public:
    PushButton(byte attachTo, byte buttonMode = INPUT_PULLUP, unsigned int debounceTimeout = DEBOUNCE_MS);
